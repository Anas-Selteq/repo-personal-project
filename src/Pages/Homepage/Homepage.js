...
function Homepage() {
    return (
        <div className='col-md-12 home_page_background'>
            <HeaderHome />
            <div className='col-md-12 padding_screen_top'>
                <div className='row'>
                    <div className='col-md-6 m-auto padding_left_homepgae padding_top_mobile'>
                        <p className='m-0 p-0 color_media ps-1'>_Hi all. I am</p>
                    ...
                    <div className='col-md-6 py-5 display_pc'>
                        <img className='img-fluid img_width_med_screen' src='/images/snakegame.png' />
                    </div>
                </div>
            </div>
        </div>
